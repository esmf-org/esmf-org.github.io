...
$key = q/sec:mesh:capi:meshaddelements/;
$external_latex_labels{$key} = q|19.3.1|; 
$noresave{$key} = "$nosave";
...
$key = q/const:ctypekind/;
$external_latex_labels{$key} = q|31.12|; 
$noresave{$key} = "$nosave";

$key = q/sec:mesh:capi:meshcreate/;
$external_latex_labels{$key} = q|19.3.3|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:mesh:capi:meshaddnodes/;
$external_latex_labels{$key} = q|19.3.2|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:coordspec/;
$external_latex_labels{$key} = q|18.1.5|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:ShapeShortcut/;
$external_latex_labels{$key} = q|18.1.3|; 
$noresave{$key} = "$nosave";
...
$key = q/const:unmappedaction/;
$external_latex_labels{$key} = q|31.13|; 
$noresave{$key} = "$nosave";

$key = q/sec:desc:dist/;
$external_latex_labels{$key} = q|18.1.4|; 
$noresave{$key} = "$nosave";
