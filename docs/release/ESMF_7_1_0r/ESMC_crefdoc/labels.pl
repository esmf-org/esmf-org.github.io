...
$key = q/sec:mesh:capi:meshaddelements/;
$external_latex_labels{$key} = q|20.3.1|; 
$noresave{$key} = "$nosave";

$key = q/const:cregion/;
$external_latex_labels{$key} = q|32.15|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:coordspec/;
$external_latex_labels{$key} = q|19.1.5|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:TimeInterval/;
$external_latex_labels{$key} = q|27.1|; 
$noresave{$key} = "$nosave";
...
$key = q/const:ctypekind/;
$external_latex_labels{$key} = q|32.18|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:Time/;
$external_latex_labels{$key} = q|26.1|; 
$noresave{$key} = "$nosave";
...
$key = q/const:cmethod/;
$external_latex_labels{$key} = q|32.12|; 
$noresave{$key} = "$nosave";
...
$key = q/const:unmappedaction/;
$external_latex_labels{$key} = q|32.19|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:desc:dist/;
$external_latex_labels{$key} = q|19.1.4|; 
$noresave{$key} = "$nosave";

$key = q/const:creduce/;
$external_latex_labels{$key} = q|32.14|; 
$noresave{$key} = "$nosave";
...
$key = q/sec:RHandle/;
$external_latex_labels{$key} = q|22.1|; 
$noresave{$key} = "$nosave";
