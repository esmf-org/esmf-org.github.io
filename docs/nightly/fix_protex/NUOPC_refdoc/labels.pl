...
$key = q/NUOPC_AddNestedState/;
$external_latex_labels{$key} = q|3.9.2 NUOPC_AddNestedState|; 
$noresave{$key} = "$nosave";

$key = q/NUOPC_AdvertiseField/;
$external_latex_labels{$key} = q|3.9.3 NUOPC_Advertise|; 
$noresave{$key} = "$nosave";

$key = q/NUOPC_AdvertiseFields/;
$external_latex_labels{$key} = q|3.9.4 NUOPC_Advertise|; 
$noresave{$key} = "$nosave";
...
$key = q/NUOPC_CplCompAttributeIng/;
$external_latex_labels{$key} = q|3.6.16 NUOPC_CompAttributeIngest|; 
$noresave{$key} = "$nosave";

$key = q/NUOPC_CplCompAttributeIngHC/;
$external_latex_labels{$key} = q|3.6.18 NUOPC_CompAttributeIngest|; 
$noresave{$key} = "$nosave";
...
$key = q/NUOPC_GridCompAttributeIng/;
$external_latex_labels{$key} = q|3.6.15 NUOPC_CompAttributeIngest|; 
$noresave{$key} = "$nosave";

$key = q/NUOPC_GridCompAttributeIngHC/;
$external_latex_labels{$key} = q|3.6.17 NUOPC_CompAttributeIngest|; 
$noresave{$key} = "$nosave";

$key = q/NUOPC_GridCompSetClock/;
$external_latex_labels{$key} = q|3.6.38 NUOPC_CompSetClock|; 
$noresave{$key} = "$nosave";
...
$key = q/NUOPC_RealizeCompleteG/;
$external_latex_labels{$key} = q|3.9.22 NUOPC_Realize|; 
$noresave{$key} = "$nosave";

$key = q/NUOPC_RealizeCompleteLS/;
$external_latex_labels{$key} = q|3.9.23 NUOPC_Realize|; 
$noresave{$key} = "$nosave";

$key = q/NUOPC_RealizeCompleteM/;
$external_latex_labels{$key} = q|3.9.24 NUOPC_Realize|; 
$noresave{$key} = "$nosave";

$key = q/NUOPC_RealizeField/;
$external_latex_labels{$key} = q|3.9.25 NUOPC_Realize|; 
$noresave{$key} = "$nosave";

$key = q/NUOPC_RealizeTransfer/;
$external_latex_labels{$key} = q|3.9.26 NUOPC_Realize|; 
$noresave{$key} = "$nosave";
...
$key = q/api_NUOPC_SCRIPWrite/;
$external_latex_labels{$key} = q|3.10.1 NUOPC_Write|; 
$noresave{$key} = "$nosave";
